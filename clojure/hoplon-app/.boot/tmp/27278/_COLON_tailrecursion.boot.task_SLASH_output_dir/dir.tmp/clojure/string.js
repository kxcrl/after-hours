...
{{
var G__12057 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12057;
continue;
}
} else
...
{var pred__12061 = cljs.core._EQ_;var expr__12062 = limit;if(cljs.core.truth_(pred__12061.call(null,1,expr__12062)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12061.call(null,2,expr__12062)))
...
var G__12064 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12065 = (limit__$1 - 1);
var G__12066 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12064;
limit__$1 = G__12065;
parts = G__12066;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12068 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12068))
{var replacement_12069 = temp__4090__auto___12068;buffer.append([cljs.core.str(replacement_12069)].join(''));
} else
{buffer.append(ch);
}
{
var G__12070 = (index + 1);
index = G__12070;
continue;
}
}
